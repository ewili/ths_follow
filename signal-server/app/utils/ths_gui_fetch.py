...
def fetch_funds_stock(trader: Any) -> tuple[dict, list[dict]]:
    """单次进入「查询 → 资金股票」：静态控件读资金 + 一次 Copy 读持仓。"""
